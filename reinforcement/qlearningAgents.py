...
class QLearningAgent(ReinforcementAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        """
        "*** YOUR CODE HERE ***"
        learned = reward + self.discount * self.computeValueFromQValues(nextState)
        self.qValues[state, action] = (1 - self.alpha) * self.getQValue(state, action) + self.alpha * learned
